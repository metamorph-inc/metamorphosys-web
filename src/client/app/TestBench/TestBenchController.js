...
define( [ '../../js/DesertFrontEnd',
    'xmljsonconverter',
    '../DesertConfigurations/DesertConfigurations'
], function ( DesertFrontEnd, Converter ) {
    'use strict';

    //    angular.module('cyphy.ui.testBench', ['cyphy.ui.desertConfigurations']);

    var TestBenchController = function ( $scope, $rootScope, $routeParams, growl, NodeService, NodeUtilities,
        DesertConfigurationServices, smartClient, Chance ) {
        var self = this,
        ...
        self.NS.on( self.context, 'initialize', function ( currentContext ) {
            ...
            self.context.regionId = ( new Date() )
