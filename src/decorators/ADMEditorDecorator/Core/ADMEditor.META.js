...
define(['underscore',
    ...
    var _isACMFolder = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.ACMFolder); };
    var _isADMEditorModelingLanguage = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.ADMEditorModelingLanguage); };
    var _isADMFolder = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.ADMFolder); };
    var _isATMFolder = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.ATMFolder); };
    var _isAVMComponentModel = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.AVMComponentModel); };
    var _isAVMDesignModel = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.AVMDesignModel); };
    var _isAVMTestBenchModel = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.AVMTestBenchModel); };
    ...
    var _isContainer = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Container); };
    var _isCustomFormula = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.CustomFormula); };
    var _isFCO = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.FCO); };
    var _isFormula = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Formula); };
    var _isProject = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Project); };
    var _isProjects = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Projects); };
    var _isProperty = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Property); };
    var _isSimpleFormula = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.SimpleFormula); };
