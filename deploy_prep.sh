...
<src/app/mmsApp/config.client.default.json sed s@http://localhost:3000@${CONTENT_SERVER:-http://mmsapp-components.metamorphsoftware.com}@ > src/app/mmsApp/config.client.json
